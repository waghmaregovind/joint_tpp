...
class LogNormMix(RecurrentTPP):
    ...
    def __init__(
        ...
        self.linear = nn.Linear(self.context_size, 3 * self.num_mix_components * num_marks)
    ...
    def get_inter_time_dist(self, context: torch.Tensor) -> torch.distributions.Distribution:
        ...
        raw_params = raw_params.reshape(-1,raw_params.shape[1],self.num_marks,3 * self.num_mix_components)
